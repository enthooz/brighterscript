...
describe('ProgramBuilder', () => {
    ...
    it('uses a unique logger for each builder', async () => {
        ...
        (0, chai_config_spec_1.expect)(builder1.logger.logLevel).to.equal(Logger_1.LogLevel.info);
        (0, chai_config_spec_1.expect)(builder2.logger.logLevel).to.equal(Logger_1.LogLevel.error);
    });

...
describe('util', () => {
    ...
    describe('loadConfigFile', () => {
        ...
        it('returns proper list of ancestor project paths', () => {
            ...
            (0, chai_config_spec_1.expect)(util_1.default.loadConfigFile((0, util_1.standardizePath) `${testHelpers_spec_1.rootDir}/child.json`)._ancestors.map(x => (0, util_1.standardizePath)(x))).to.eql([
        ...
        it('returns empty ancestors list for non-extends files', () => {
            ...
            (0, chai_config_spec_1.expect)(config._ancestors.map(x => (0, util_1.standardizePath)(x))).to.eql([
                (0, util_1.standardizePath) `${testHelpers_spec_1.rootDir}/child.json`
            ]);
        });
        it('resolves plugins path relatively to config file', () => {
            ...
            (0, chai_config_spec_1.expect)(config.plugins.map(p => (p ? util_1.default.pathSepNormalize(p, '/') : undefined))).to.deep.equal([
    ...
    describe('comparePositionToRange', () => {
        it('does not crash on undefined props', () => {
            (0, chai_config_spec_1.expect)(util_1.default.comparePositionToRange(null, util_1.default.createRange(0, 0, 0, 0))).to.eql(0);
            (0, chai_config_spec_1.expect)(util_1.default.comparePositionToRange(util_1.default.createPosition(1, 1), null)).to.eql(0);
        });
    ...
    describe('rangesIntersect', () => {
        it('does not crash on undefined range', () => {
            (0, chai_config_spec_1.expect)(util_1.default.rangesIntersect(null, util_1.default.createRange(0, 0, 0, 0))).to.be.false;
            (0, chai_config_spec_1.expect)(util_1.default.rangesIntersect(util_1.default.createRange(0, 0, 0, 0), null)).to.be.false;
        });
    ...
    describe('rangesIntersectOrTouch', () => {
        it('does not crash on undefined range', () => {
            (0, chai_config_spec_1.expect)(util_1.default.rangesIntersectOrTouch(null, util_1.default.createRange(0, 0, 0, 0))).to.be.false;
            (0, chai_config_spec_1.expect)(util_1.default.rangesIntersectOrTouch(util_1.default.createRange(0, 0, 0, 0), null)).to.be.false;
        });
        it('does not match when ranges do not touch (a < b)', () => {
            // AA BB
            (0, chai_config_spec_1.expect)(util_1.default.rangesIntersectOrTouch(util_1.default.createRange(0, 0, 0, 1), util_1.default.createRange(0, 2, 0, 3))).to.be.false;
